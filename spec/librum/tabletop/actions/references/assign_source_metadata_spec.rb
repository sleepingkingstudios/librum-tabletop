...
RSpec.describe Librum::Tabletop::Actions::References::AssignSourceMetadata do
  ...
  example_class 'Spec::Action', Cuprum::Command do |klass|
    klass.prepend(Librum::Tabletop::Actions::References::AssignSourceMetadata) # rubocop:disable RSpec/DescribedClass
